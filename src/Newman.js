...
var Newman = jsface.Class([Options, EventEmitter], {
     ...
     */
     ...
     /***-s- Custom Code ***/
    execute: function (requestJSON, options, eventListener, callback) {
    /***-e- Custom Code ***/
        ...
        /***-s- Custom Code ***/
        //this.addEventListener('requestExecuted', eventListener);
        this.addEventListener('requestTestsExecuted', eventListener);
        var _this = this;
        /***-e- Custom Code ***/        
