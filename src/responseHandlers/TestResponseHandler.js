...
var TestResponseHandler = jsface.Class(AbstractResponseHandler, {
    ...
    _onRequestExecuted: function(error, response, body, request) {
        ...
        /***-s- Custom Code ***/
        newResultObj = ResponseExporter._createResultObject(request, response, results);
        console.log('********* _onRequestExecuted: ', newResultObj);
        this.emit('requestTestsExecuted', request, newResultObj);
        /***-e- Custom Code ***/        
